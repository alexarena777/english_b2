...
const useOfEnglishSeeds: UseOfEnglishSeed[] = [
  ...
  { type: "multiple-choice", topic: "Multiple-choice cloze", question: "Gap 9: he was ___ aware of the consequences", answer: "fully", options: ["deeply", "entirely", "fully", "highly"], explanation: "Fully aware è una collocazione molto comune in inglese.", contextTitle: "A new evening course", context: eveningCourseCloze },
  { type: "multiple-choice", topic: "Multiple-choice cloze", question: "Gap 10: it turned ___ to be a great success", answer: "out", options: ["out", "up", "into", "over"], explanation: "Turn out to be significa rivelarsi essere in un certo modo alla fine.", contextTitle: "A new evening course", context: eveningCourseCloze },
  { type: "multiple-choice", topic: "Multiple-choice cloze", question: "Gap 11: they couldn't figure ___ how to do it", answer: "out", options: ["in", "on", "out", "off"], explanation: "Figure out significa capire, risolvere un problema.", contextTitle: "A new evening course", context: eveningCourseCloze },
  { type: "multiple-choice", topic: "Multiple-choice cloze", question: "Gap 12: to make ___ for the lost time", answer: "up", options: ["out", "up", "for", "over"], explanation: "Make up for significa compensare qualcosa (in questo caso il tempo perduto).", contextTitle: "A new evening course", context: eveningCourseCloze },
  ...
  { type: "fill-gap", topic: "Open cloze", question: "Gap 9: depends ___ the individual student", answer: "on", explanation: "Il verbo depend regge la preposizione on.", contextTitle: "Studying on the move", context: commutingCloze },
  { type: "fill-gap", topic: "Open cloze", question: "Gap 10: ___ order to succeed", answer: "in", explanation: "L'espressione per indicare lo scopo è in order to.", contextTitle: "Studying on the move", context: commutingCloze },
  { type: "fill-gap", topic: "Open cloze", question: "Gap 11: such ___ reading a book", answer: "as", explanation: "Such as si usa per fare esempi.", contextTitle: "Studying on the move", context: commutingCloze },
  { type: "fill-gap", topic: "Open cloze", question: "Gap 12: there is no point ___ worrying", answer: "in", explanation: "L'espressione corretta è there is no point in + gerundio.", contextTitle: "Studying on the move", context: commutingCloze },
  ...
  { type: "transformation", topic: "Key word transformation", question: "I regret not accepting that offer. → I wish ___ that offer. (ACCEPTED)", answer: "I had accepted", accepted: ["I'd accepted"], explanation: "Wish + past perfect esprime un rimpianto sul passato." },
  ...
  { type: "transformation", topic: "Key word transformation", question: "I am sure he didn't do it on purpose. → He ___ it on purpose. (CAN'T)", answer: "can't have done", explanation: "Can't have + participio passato si usa per deduzioni negative riguardanti il passato." },
  { type: "transformation", topic: "Key word transformation", question: "Someone is fixing my car tomorrow. → I am ___ tomorrow. (HAVING)", answer: "having my car fixed", explanation: "Have something done esprime un servizio che viene svolto da altri." },
  { type: "transformation", topic: "Key word transformation", question: "Despite the heavy rain, they played the match. → Although ___, they played the match. (IT)", answer: "it was raining heavily", accepted: ["it rained heavily"], explanation: "Although richiede una frase completa (soggetto + verbo), contrariamente a despite." },
  { type: "transformation", topic: "Key word transformation", question: "He started studying Spanish two years ago. → He ___ two years. (BEEN)", answer: "has been studying Spanish for", explanation: "Il present perfect continuous (has been studying) con 'for' indica un'azione iniziata nel passato e ancora in corso." },
  { type: "transformation", topic: "Key word transformation", question: "They didn't give me the instructions. → I ___ the instructions. (GIVEN)", answer: "was not given", accepted: ["wasn't given"], explanation: "Struttura passiva in cui il complemento di termine diventa soggetto." },
];
